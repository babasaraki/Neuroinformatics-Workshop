...
Work through the tutorial on the Unix Shell from Software Carpentry and create a notes file. Turn in your notes by email before class on Saturday. Note that the recommended time to teach this entire tutorial is 4.5 hours. I don't know how long it will take each of you independently to work through it but I think more than 1 hour should be a minimum.
